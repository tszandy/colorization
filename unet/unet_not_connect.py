...
class UNET_NO_CONNECT(nn.Module):

    def __init__(self, n_channels, n_classes):
        super(UNET_NO_CONNECT, self).__init__()
        ...
        self.dc8=nn.ConvTranspose2d(512, 512, 4, 2, 1)
        self.dc7=nn.Conv2d(512, 256, 3, 1, 1)
        self.dc6=nn.ConvTranspose2d(256, 256, 4, 2, 1)
        self.dc5=nn.Conv2d(256, 128, 3, 1, 1)
        self.dc4=nn.ConvTranspose2d(128, 128, 4, 2, 1)
        self.dc3=nn.Conv2d(128, 64, 3, 1, 1)
        self.dc2=nn.ConvTranspose2d(64, 64, 4, 2, 1)
        self.dc1=nn.Conv2d(64, 32, 3, 1, 1)
        self.dc0=nn.Conv2d(32, n_classes, 3, 1, 1)
    ...
    def forward(self, x):
        ...
        d8 = F.relu(self.bnd8(self.dc8(e8)))
        del e8
        d7 = F.relu(self.bnd7(self.dc7(d8)))
        del d8
        d6 = F.relu(self.bnd6(self.dc6(d7)))
        del d7
